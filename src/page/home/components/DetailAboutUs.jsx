export const DetailAboutUs = () => {
    return (
        <div className="flex flex-col md:flex-row max-w-full mx-auto space-y-6 md:space-y-0 md:space-x-6">
            <div className="w-full bg-gray-50 text-black py-10 px-6 rounded-lg text-center md:text-left">
                <h2 className="text-4xl font-extrabold text-blue-600 mb-6">Tại sao nên chọn KhaMinh Station</h2>
